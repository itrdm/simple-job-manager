	...
	<body>
		...
		<table class="invoice_header_table" > 
			...
			<tr>
				<td > &nbsp; </td>
				<td class="invoice_id"> 
					<?php echo apply_filters('albwppm_invoice_pdf_invoice_id',__('Invoice','simple-job-managment') .' '.$invoice_id, $invoice_id); ?>
				</td>
			</tr>
		</table>
		...
		<table class="order_items">
			<thead>
				<tr>
					<td class="description_title"> <?php echo apply_filters('albwppm_invoice_pdf_description_table_header',__('Description','simple-job-managment')); ?></td>
					<td> <?php echo apply_filters('albwppm_invoice_pdf_price_table_header',__('Price','simple-job-managment')); ?> </td>
					<td> <?php echo apply_filters('albwppm_invoice_pdf_quantity_table_header',__('Quantity','simple-job-managment')); ?> </td>
					<td> <?php echo apply_filters('albwppm_invoice_pdf_total_table_header',__('Total','simple-job-managment')); ?> </td>
				</tr>	
			</thead>
			<tbody>
				...
				<tr class="before_subtotal_separator"> <td colspan="4" class="no-borders"> &nbsp; </td></tr>
					...
					<tr>
						...
						<?php if($subtotal!=''){ ?>
							<td colspan="2" class="subtotal_title"> <?php echo apply_filters('albwppm_invoice_pdf_subtotal_table_header',__('Subtotal','simple-job-managment')); ?> </td>
				...
				<?php if($discount!=''){ ?>
					<tr>
						<td class="no-borders"> &nbsp; </td>
						<td colspan="2"  class="discount_title"> <?php echo apply_filters('albwppm_invoice_pdf_discount_table_header',__('Discount','simple-job-managment')); ?> </td>
				...
				<?php if($subtotal_after_discount !=''){ ?>
					<tr>
						<td class="no-borders"> &nbsp; </td>
						<td colspan="2"  class="subtotal_after_discount_title"> <?php echo apply_filters('albwppm_invoice_pdf_subtotal_after_discount_table_header',__('Subtotal after discount','simple-job-managment')); ?> </td>
				...
				<?php if($vat!=''){ ?>
					<tr>
						<td class="no-borders"> &nbsp; </td>
						<td colspan="2"  class="vat_title"> <?php echo apply_filters('albwppm_invoice_pdf_vat_table_header',__('VAT','simple-job-managment')); ?> </td>
			...
			<tfoot>
					...
					<?php if($total!=''){ ?>
						<tr >
							<td class="no-borders"> &nbsp; </td>
							<td colspan="2"  class="balance_due_title"> <?php echo apply_filters('albwppm_invoice_pdf_balance_header',__('Balance','simple-job-managment')); ?>  </td>
		...
		<?php if($invoice_specific_terms!=''){ ?>
			<div > 
				<span class="invoice_specific_terms_title">  <?php echo apply_filters('albwppm_invoice_pdf_specific_terms_header',__('Specific terms','simple-job-managment')); ?>   </span>
		...
		<?php if($invoice_general_terms_and_conditions!=''){ ?>
			<div > 
				<span class="invoice_general_terms_title">  <?php echo apply_filters('albwppm_invoice_pdf_general_terms_header',__('General terms','simple-job-managment')); ?>  </span>
		...
		<div id="footer">
			...
			<?php if($company_email!=''){ ?>
				<span class="company_email_title"><?php echo apply_filters('albwppm_invoice_pdf_email_footer_header',__('Email','simple-job-managment')); ?> </span><?php echo $company_email; ?>
			<?php } ?>
			
			<?php if($company_website!=''){ ?>
				<span class="company_website_title"><?php echo apply_filters('albwppm_invoice_pdf_email_website_header',__('Web','simple-job-managment')); ?> </span><?php echo $company_website; ?> 
			<?php } ?>
			
			<?php if($company_mobile!=''){ ?>
				<span class="company_mobile_title"><?php echo apply_filters('albwppm_invoice_pdf_email_mobile_header',__('Mobile','simple-job-managment')); ?> </span><?php echo $company_mobile; ?> 
			<?php } ?>
		</div>
