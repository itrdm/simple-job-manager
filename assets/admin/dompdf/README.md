...
```php
// somewhere early in your job's loading, require the Composer autoloader
 ...
 * If you find this job useful, please consider making a donation.

(Any funds donated will be used to help further development on this job.)	
